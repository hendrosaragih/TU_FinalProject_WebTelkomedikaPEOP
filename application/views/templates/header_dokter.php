...
<nav class="navbar navbar-expand-lg navbar-red bg-red fixed-top">
    <a class="navbar-brand" href="<?= base_url();?>dokter/home"><img src="http://localhost/telkomedika/assets/gambar/jary.jpg" style="width:40px"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto">
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('dokter/home'); ?>">Beranda</a>
            </li>
            <li class="nav-item">
            <span class="nav-link">|</span>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link" href="<?php echo base_url("dokter/CekJadwalPraktek"); ?>">Jadwal Praktek</a>
            </li>
            <li class="nav-item">
                <span class="nav-link">|</span>
            </li>
        ...
        <ul class="navbar-nav" style="margin-right:80px">
            <li class="navbar-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="<?php echo base_url("dokter/logout"); ?>" onclick="return confirm('Apakah anda yakin untuk keluar ?');">Logout</a>
                </div>
            </li>  
        </ul>
    </div>
