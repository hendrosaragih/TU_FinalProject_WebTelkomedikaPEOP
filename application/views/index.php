      ...
      <div class="container">
        <div class="row">
            <div class="intro-text col-md-6">
              <a class="btn btn-xl text-uppercase js-scroll-trigger" style="background:#212529" href="<?php echo base_url('pasien/landing_pasien'); ?>">Pasien</a>
            </div>
            <div class="intro-text col-md-6">
...
<!--               <a class="" href="pelanggan/login.php">Employee</a> -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="http://localhost/telkomedika/">
